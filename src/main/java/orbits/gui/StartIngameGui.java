...
public interface StartIngameGui extends Gui {

    class Simple extends ParentableAbstractGui implements StartIngameGui {
        ...
        public Simple(OrbitsGame orbits, Connection connection, @Nullable OrbitsServer server) throws GameException {
            ...
            if (launcher().operatingSystem() == DefaultOperatingSystems.ANDROID) {
                handshakeFuture.thenRun(() -> connection.sendPacket(new PacketNewPlayer(0, 'A')));
            }
        }
